<template>
    <div>
        <div class="container mx-auto mt-10 mb-10">
            <h1>About page</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint, quidem voluptatum! Reprehenderit ab exercitationem et accusantium doloremque doloribus, qui ipsa consequatur, possimus alias veritatis voluptatem nulla nemo porro facere pariatur in eligendi odio placeat eum magnam, sed fugit. Pariatur, accusamus ducimus! Eaque natus inventore nihil officiis omnis accusamus quaerat velit!</p>
        </div>
        <div class="container mx-auto bg-gray-100 overflow-hidden shadow sm:rounded-lg mt-20j">
